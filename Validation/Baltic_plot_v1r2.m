...
% 
% Description
% Plot to see SSS (BEC) data in the Baltic
% version: v1r2
% 
% Script switches
% data_type for Balttic: 
%           [4] Baltic-Nominal
%           [5] Baltic-Nodal Sampling
%           [6] Global BEC product (v001) [default] 
...
%
% History
% v1r2 [-3/07/2020] update the function to read SMOS (BEC) data
% v1r1 [05/08/2019] make this script
%
%
% Author: rcatany
%
...
[A] = rd_smos_L4_BEC_v1r3(itime,ibasin,data_type);

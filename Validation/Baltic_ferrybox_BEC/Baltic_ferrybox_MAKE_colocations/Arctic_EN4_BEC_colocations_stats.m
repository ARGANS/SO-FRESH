function [vars_out] = Arctic_EN4_BEC_colocations_stats(fn_in)
%
% Syntax (function):
% [vars_out] = Arctic_EN4_BEC_colocations_stats(fn_in)
%
% Description
...
folder_out = [path_root...
    'SSS/' basin_str...
    '/BEC/Validation/indata/EN4/Colocations/' version_str '/'];

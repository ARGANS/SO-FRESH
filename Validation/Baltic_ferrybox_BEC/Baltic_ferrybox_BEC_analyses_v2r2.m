% Syntax: Baltic_ferrybox_BEC_analyses_v2r1.m (script)
%
% Description
...
iships = 2;     % [2] Finnamaid, [3] Romantika and [5] Transpaper check options (type help Baltic_ferrybox_BEC_analyses_v2r1.m)
iyear = 2011:2013;
imonth = 1:12;
...
folder_data = ([path_root ...
    'SSS/' basin_str '/BEC/Validation/indata/ferrybox/']);
...
folder_colocations = [path_root...
    'SSS/Baltic/BEC/Validation/indata/ferrybox/Colocations/cat_files/' ];
...
folder_figs = [folder_figs basin_str '/ferrybox/'];

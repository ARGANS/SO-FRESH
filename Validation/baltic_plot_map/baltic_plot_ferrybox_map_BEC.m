% Syntax: plot_map_ferrybox_BEC (script-snipt of Baltic_ferrybox_BEC_analyses.m)
%
% Description
...
% Save figure  - output -
fg_name = ['ferrybox_' itime_start_str '_' itime_end_str ...
    '_MAP_' region '_' ships_str '_'...
...
title({[ships_str ' ferrybox colocations to Baltic ' version_str];...
    [basin_str ' (' region ', ' ...
    num2str(ymin) '-' ...
    num2str(ymax) '\circ N) ' ];...

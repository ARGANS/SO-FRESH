...
if __name__ == "__main__":
    try:
        ...
        #----------------------------------------------------------------------------------------------------
        # tasks to do:
        # read image, check products in path name.
        # maybe hard code some functions for the optical and thermal products
        # check bands variation in values? 
        # run gdal_calc on it for classification, change from all bands to 123 optical and 4 thermal.
        # boom classification
